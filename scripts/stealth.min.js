...
(({ _utilsFns: _utilsFns, _mainFunction: _mainFunction, _args: _args }) => {
    ...
    _args: [{
      fns: {
        generateMimeTypeArray:
          "(utils, fns) => mimeTypesData => {\n  return fns.generateMagicArray(utils, fns)(\n    mimeTypesData,\n    MimeTypeArray.prototype,\n    MimeType.prototype,\n    'type'\n  )\n}",
        generatePluginArray:
          "(utils, fns) => pluginsData => {\n  return fns.generateMagicArray(utils, fns)(\n    pluginsData,\n    PluginArray.prototype,\n    Plugin.prototype,\n    'name'\n  )\n}",
        generateMagicArray:
  ...
  !1 === navigator.webdriver || void 0 === navigator.webdriver ||
  ...
  (() => {
    try {
      ...
      window.outerWidth = window.innerWidth,
        window.outerHeight = window.innerHeight + n;
    } catch (n) {}
  })(),
  (({ _utilsFns: _utilsFns, _mainFunction: _mainFunction, _args: _args }) => {
    const utils = Object.fromEntries(
